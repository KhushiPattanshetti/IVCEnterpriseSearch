...
def run_rag_pipeline(content_directory, model_name, model_url, query, similarity_top_k=4):
    """
    Run the Retrieval-Augmented Generation (RAG) pipeline with LlamaIndex and LlamaCPP.

    Parameters:
        content_directory (str): Path to the directory containing the documents to index.
        model_name (str): Name of the HuggingFace embedding model to use.
        model_url (str): URL to the Llama model to load.
        query (str): The query string to retrieve and generate a response for.
        similarity_top_k (int): Number of top similar documents to retrieve. Default is 4.

    Returns:
        str: The response generated by the LLM for the augmented query.
    """
    import os
